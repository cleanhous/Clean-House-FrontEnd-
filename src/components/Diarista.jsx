...
const Diarista = () => {
  ...
  const handleCheckAvailability = (diarista) => {
    setSelectedEletricista(diarista);
    setShowPopup(true);
  };
            ...
            filteredDiarista.map((diarista) => (
              ...
              >
                ...
                <div className="flex items-center mt-4">
                  ...
                  <a href={`https://wa.me/55${diarista.telefone.replace(/[^\d]/g, '')}`} target="_blank" rel="noopener noreferrer" className="text-green-700 "> Whatsapp
                  </a>
                  </span>
                </div>
      ...
      {showConfirmationPopup && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <p className="mb-4">
              A contratação do diarista {selectedEletricista.nome} foi
