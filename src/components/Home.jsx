    ...
    <div className="min-h-screen flex flex-col bg-sky-700">
      ...
      <div className="flex-1 ">
        ...
        <div className="w-full bg-white h-48 p-2 md:p-8 md:h-auto">
          <p className="text-center text-xl mb-4 text-sky-700 font-semibold md:text-4xl md:font-bold">
            Alguns de nossos serviços
          </p>
          <div className="flex justify-between md:justify-around">
            <div className="shadow-lg rounded-full w-28 h-28 bg-gray-200 p-4 flex flex-col justify-center items-center  md:rounded-none md:w-auto md:h-72 md:p-0 md:bg-white md:shadow-2xl">
              <p className="text-sky-700 text-lg md:mt-6 md:text-2xl">
                Eletricista
              </p>
              <img className="hidden md:block w-96 h-auto" src={eletricista} />
      ...
      <div className="mt-6 p-3 mx-4 mb-6 flex flex-col items-center bg-white rounded-lg md:flex-row md:justify-around md:h-64">
